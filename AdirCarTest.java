public class AdirCarTest {
    ...
    public static void main(String[] args) {
        ...
        test(c1.isBetter(c3) == false);
        test(c1.isBetter(c1) == false);
        test(c10.isBetter(c10) == false);
        test(c3.isBetter(c1));
        test(c1.isBetter(c8));
        test(c8.isBetter(c1) == false);
        test(c9.isBetter(c1));
        test(c9.isBetter(c3) == false);
        test(c9.isBetter(c10) == false);
        test(c3.isBetter(c5));
        test(c3.isBetter(c6));
        test(c10.isBetter(c1));
        test(c10.isBetter(c3));
        test(c10.isBetter(c5));
        test(c10.isBetter(c11));
